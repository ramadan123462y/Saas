                            ...
                            @foreach ($wishe_list as $item)
                                <tr class="tr">
                                    <td>
                                        <div class="media">
                                            <div class="d-flex">
                                                {{-- public/storage/Images/Products/account_info.JPG --}}
                                                <img style="width: 50px;height:50px;" src="{{ URL::asset('storage/Images/Products/'.$item->product->file_name) }}" alt="" />
                                            </div>
                                    ...
                                    <td class="tdtotal">
                                        ...
                                        <h5 class="total">${{ $item->product->selling_price }}</h5>
                                    </td>
                                    <td class="tdtotal">

                                        <a href="{{ url('wishlist/delete',$item->id) }}" class="btn btn-outline-danger">Delete</a>
                                    </td>
                                    <td class="tdtotal">

                                        <a href="{{ url('cart/store',$item->product_id) }}" class="btn btn-outline-info">Add To Cart</a>
                                    </td>
                                </tr>
                            @endforeach
