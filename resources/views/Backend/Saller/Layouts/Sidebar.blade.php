    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ url('/') }}">
                ...
                <span>Demo Store(View Store)</span>
            </a>
        ...
        <li class="nav-item">
            ...
            <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ url('/saller/dashboard/order') }}">
            ...
            <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ url('/saller/dashboard/customer') }}">
        ...
        <li class="nav-item">
            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ url('saller/dashboard/categories') }}">
                        <i class="bi bi-circle"></i><span>Categories</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url('saller/dashboard/categories/archive') }}">
        ...
        <li class="nav-item">
            ...
            <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ url('saller/dashboard/transaction') }}">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{{ url('saller/dashboard/setting') }}">
